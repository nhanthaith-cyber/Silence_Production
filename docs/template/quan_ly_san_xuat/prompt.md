...
1. **Card "Các lô hàng đang gia công" (Active Pipelines):**
   ...
   - **Danh sách lô sản xuất (Batch Cards List):** Mỗi lô hàng đang chạy hiển thị dưới dạng một card độc lập hình chữ nhật bo góc nhẹ. Bên trong card gồm:
     ...
     - **Luồng tiến độ trực quan (Visual Flow Steps):** Một thanh ngang gồm 5 vòng tròn tiến độ được kết nối với nhau bằng các đường kẻ (connector):
       ...
       - Bước 5: **Trả hàng**
       - Các bước đã hoàn thành hiển thị màu xanh lá kèm biểu tượng CheckCircle. Bước hiện tại hiển thị màu vàng hổ phách có số thứ tự. Các bước chưa tới hiển thị màu xám. Đầu nối connector giữa các bước hoàn thành có màu xanh lá cây, ngược lại có màu xám.
     - **Nút chuyển đổi công đoạn:** Nút bấm lớn màu xanh lá (chữ trắng) trải dài toàn bộ chiều rộng card, ghi rõ hành động tiếp theo: "Chuyển sang công đoạn: [TÊN CÔNG ĐOẠN TIẾP THEO]" kèm biểu tượng mũi tên chỉ sang phải.
